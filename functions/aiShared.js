...
async function fetchWebPage(url) {
  if (!isValidHttpUrl(url)) throw new Error('Enter a valid http or https URL')
  ...
  try {
    const res = await fetch(url, {
      ...
      headers: {
        'User-Agent': 'Mozilla/5.0 (compatible; APTrackBot/1.0)',
...
module.exports = { callGemini, fetchWebPage, isKeyConfigured }
